...
% Load material data
data = readtable("/Volumes/ValentineLab/SimulationData/Rahul/Material Dielectric Function/Si_Experimental_800to1700_100pts_modified.xlsx");
...
% pillar_type = "cross";
% pillar_type = "anticross";
pillar_type = 'cross_with_cap';
            ...
            for j1 = 1:num_width
                ...
                for j2 = 1:num_aspect
                    ...
                    parfor k = 1:num_wavelengths
                        ...
                        % [trans, refl, trans_eff, refl_eff] = RCWA_bigcode_Absolute((wavelength(k)), h, n_substrate, n_pillar(k), n_background, pillar_type, theta, pitch, w1, w2);
                        [trans, refl, trans_eff, refl_eff] = RCWA_bigcode_Absolute((wavelength(k)), h, n_substrate, n_pillar(k), n_background, pillar_type, theta, pitch, w1, w2, h1, n_cap);
